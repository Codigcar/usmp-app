...
import { Header, RowValidator } from '../../components'
import {
...
import useChangePasswordInteractor from './ChangePassword.interactor'
...
const ChangePasswordScreen = () => {
  ...
  //   >()
  // const { params } =
  //   useNavigation<ProfileStackScreenProps<'ChangePasswordScreen2'>['route']>()
